...
from ToolChain.Compiler.Compiler import Compiler
from ToolChain.Compiler.Constants import UNDEFINED, DEFAULT_OUTPUT_EXTENSION
...
def parseCommandLineArgs():
    ...
    parser.add_argument("-i", "--input",
                        ...
                        nargs=1,
                        type=str,
                        help="Define the input file to be used by the compiler.")
...
if __name__ == '__main__':
    ...
    if os.path.exists(usableArgs.output):
        # The compiler did the job correctly and the out file has been written to disk!
        print("Compiler done, output file has been written to {}". format(usableArgs.output,))
    else:
        raise ValueError("An unknown error occurred while compiling the input file. Please validate "
                         ...
                         "stable compiler. If you don't report, don't whine about this!")
